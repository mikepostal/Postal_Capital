				...
				<!--  Tasks  -->
                    ...
                    <li class="sidebar-item">
		             ...
		             <li class="sidebar-item <c:if test="${requestScope['javax.servlet.forward.request_uri'].indexOf('/payrollSummary/') >= 0}"> active </c:if>">
					    <a href="${pageContext.request.contextPath}/regional/payrollSummary/getAll" class="sidebar-link"> <i class="bi bi-coin"></i><span>Payroll Summary</span></a>
				     </li>
            <!--
				<li
...
<script type="text/javascript">
	$(document).ready(
			function() {
			    ...
			    else if(url.includes('payrollSummary') 
				          || url.includes('payrollSummary')) {
				          $('.taskstatus-submenu').show();
				          $('.taskstatus-submenu').addClass("active");
				          $(".taskstatus-submenu").prev().addClass('d-active');
				        }
