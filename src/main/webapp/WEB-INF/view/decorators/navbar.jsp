		...
		<div class="sidebar-menu">
			<ul class="menu">
				...
				<%-- <li
					...
					<ul class="submenu po-submenu">
						<li class="submenu-item"><a
							href="${pageContext.request.contextPath}/tradepairs/allTradePairs">
								<i class="bi bi-cash-stack"></i><span> Pairs</span>
						</a></li>

						<li class="submenu-item"><a
							href="${pageContext.request.contextPath}/categories/allCategories">
								<i class="bi bi-hdd-stack-fill"></i><span>Categories</span>
						</a></li>
