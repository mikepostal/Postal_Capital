...
<html>
<head>
<title>Banners Hallmark - Edit User</title>
</head>
<body>
			...
			<div class="page-heading">
				...
				<section class="section blnk-db">
					<form:form class="form-horizontals" method="post" id="user_form"
						name="user_form" onsubmit="saveForm()"
						action="${pageContext.request.contextPath}/users/updateUsers"
								...
								<div class="row" id="row4">
									...
									<div class="col-md-4 col-12">
										<div class="form-group">
											...
											<form:input type="hidden" maxlength="20"
