					...
					<div class="card">
						<div class="card-body shadow">
							<div class="ig-dflx ">
								...
								<a href="${pageContext.request.contextPath}/users/addUsers"
									class="btn btn-primary "> <i
									class="bi bi-credit-card-2-back "></i> New User
								</a>
											...
											<tr>
												...
												<td class="td-actions">
													<div class="action-buttons">
														...
														<a class="" title="Edit"
															href="${pageContext.request.contextPath}/users/getUsers?id=${users.id}">
															<span class="badge bg-success"><i
																class="bi bi-pencil"></i></span>
														</a> <a class="red"
															href="${pageContext.request.contextPath}/users/deleteUsers/${users.id}"
