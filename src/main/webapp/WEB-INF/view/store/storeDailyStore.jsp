								...
								<div class="col-7">
									<fieldset class="form-group">
										...
										<select class="form-select" onchange="dailyByMonth(this)">
											...
											<option value="${pageContext.request.contextPath}/dailyReport/dailyReportStore/1/${site}">Jan</option>
											<option value="${pageContext.request.contextPath}/dailyReport/dailyReportStore/2/${site}">Feb</option>
											<option value="${pageContext.request.contextPath}/dailyReport/dailyReportStore/3/${site}">Mar</option>
											<option value="${pageContext.request.contextPath}/dailyReport/dailyReportStore/4/${site}">Apr</option>
											<option value="${pageContext.request.contextPath}/dailyReport/dailyReportStore/5/${site}">May</option>
										</select>
									</fieldset>
								</div>
