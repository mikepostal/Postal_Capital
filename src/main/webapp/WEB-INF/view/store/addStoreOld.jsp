...
<html>
<head>
<title>BannersHallmark | Add Store</title>
</head>
<body>
			...
			<div class="box box-info">
				...
				<div class="container">
					...
					<form:form class="form-horizontals" method="post" id="user_form"
						name="user_form" action="addNewStore" modelAttribute="store">
						<div class="container">
										...
										<div class="panel-body">
											...
											<div class="col-6">
												<div class="col-xs-12 col-sm-12 col-md-6">
													...
													<div class="form-group">
														<form:input type="text"   maxlength="9" name="userId" id="userId"
												...
												<div class="col-xs-12 col-sm-12 col-md-6">
													...
													<div class="form-group">
														<form:input type="number" min="1" max="1000000" pattern="([0-9]|[0-9]|[0-9])" name="store" id="store" onkeypress="return isNumberKey(event)"
																	...
																	placeholder="Store" value="" required="true" />
													</div>
												</div>	
												</div>
												<div class="col-6">	
												...
												<div class="col-xs-12 col-sm-12 col-md-6">
													...
													<div class="form-group">
														<form:input type="text"  maxlength="50" name="storeName" id="storeName"
																	...
																	placeholder="Store Name" value="" required="true" />
													</div>
												</div>																							
											</div>
											</div>
											...
											<div class="col-6">
												<div class="col-xs-12 col-sm-12 col-md-6">
													...
													<div class="form-group">
														<form:input type="number" min="1"  max="1000" name="size" id="size" onkeypress="return isNumberKey(event)"
