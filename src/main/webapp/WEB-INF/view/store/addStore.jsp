...
<html>
	<head>
		<title>Banners Hallmark - Add Site</title>
	</head>
	<body>
            ...
            <div id="main-content">
                ...
                <div class="page-heading">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/store/stores">Sites</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Add Site
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                    ...
                    <section class="section blnk-db">
                        <form:form class="form" method="post" id="user_form" name="user_form" onsubmit="saveForm()" action="addNewStore" modelAttribute="store">
                                          ...
                                          <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <form:input type="text"  maxlength="50" name="storeName" id="storeName"
																	...
																	placeholder="Site Name" value="" required="true" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">  
                                                ...
                                                <form:input type="number" min="1" max="1000000" pattern="([0-9]|[0-9]|[0-9])" name="store" id="store" onkeypress="return isNumberKey(event)"
																	...
																	placeholder="Site" value="" required="true" />
                                            </div>
                                        </div>
