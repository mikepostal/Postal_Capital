...
<html>
<head>
<title>BannersHallmark | Update Access Permission</title>
</head>
<body>

	<!-- Content Header (Page header) -->
	<section class="content-header">
		<h1>Update Access Permission</h1>
	</section>
			...
			<div class="box box-info">
				...
				<div class="container">
					...
					<form:form class="form-horizontals" method="post" id="user_form"
						name="user_form"  action="${pageContext.request.contextPath}/accessPermission/updateAccessPermission"  modelAttribute="accessPermission">
